...
def mainCategory(url1, firebase):
    ...
    for category in categoryList:
        ...
        if num > 0 and num < 21:
            ...
            result = firebase.put('/Multipletop', num, abs)
            print(result)
        num = num + 1
    return dic_list
...
def main():
    ...
    mainCategory('https://finviz.com/screener.ashx?v=110&s=ta_p_multipletop', firebase)
    mainnext20Category('https://finviz.com/screener.ashx?v=110&s=ta_p_multipletop&r=21', firebase)