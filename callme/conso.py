...
def mainCategory(url1, firebase):
    print("Ali ")
    for i in range(1, 21):
        firebase.delete('/Consolidation', i)
        pass
    ...
    for category in categoryList:
        ...
        if num > 0 and num < 21:
            ...
            result = firebase.put('/Consolidation', num, abs)
            print(result)
        num = num + 1
    return dic_list
...
def main():
    ...
    mainCategory('https://finviz.com/screener.ashx?v=110&s=ta_p_headandshoulders', firebase)
    mainnext20Category('https://finviz.com/screener.ashx?v=110&s=ta_p_headandshoulders&r=21', firebase)